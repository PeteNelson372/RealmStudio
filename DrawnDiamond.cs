...
{
    public sealed class DrawnDiamond : DrawnMapComponent, IXmlSerializable
    {
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            XDocument diamondDoc = XDocument.Parse(content);

            if (diamondDoc.Root == null)
            {
            ...
            XElement? bottomRightElement = diamondDoc.Root.Element(ns + "BottomRight");
            ...
            XElement? colorElement = diamondDoc.Root.Element(ns + "Color");
            ...
            XElement? fillBitmapElement = diamondDoc.Root.Element(ns + "FillBitmap");
