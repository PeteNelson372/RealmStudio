...
>
{
    ...
    >
    {
        ...
        CullMode = None;
        PixelShader = compile ps_3_0 PS_Downsample(gSceneSampler, HighlightThreshold);
    }
    pass GlowH <
    ...
    >
    {
        VertexShader = compile vs_3_0 VS_Blur7(float2(1, 0), BlurWidth, QuadTexelOffsets, QuadScreenSize);
        ZEnable = false;
        ZWriteEnable = false;
        AlphaBlendEnable = false;
        CullMode = None;
	...
	>
    {
        VertexShader = compile vs_3_0 VS_Blur7(float2(0, 1), BlurWidth, QuadTexelOffsets, QuadScreenSize);
        ZEnable = false;
        ZWriteEnable = false;
        AlphaBlendEnable = false;
        CullMode = None;
