...
{
    public sealed class DrawnRectangle : DrawnMapComponent, IXmlSerializable
    {
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            if (drawRoundedElement != null)
            {
                _drawRounded = bool.Parse(drawRoundedElement.Value);
            }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteElementString("DrawRounded", DrawRounded.ToString());
