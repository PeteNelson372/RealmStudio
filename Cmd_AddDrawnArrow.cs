...
namespace RealmStudio
{
    internal class Cmd_AddDrawnArrow(MapLayer mapLayer, DrawnArrow drawnArrow) : IMapOperation
    {
        ...
        {
            mapLayer.MapLayerComponents.Add(da);
        }
        ...
        public void UndoOperation()
        {
            ...
            {
                if (mapLayer.MapLayerComponents[i] is DrawnArrow drawnArrow)
                {
                    if (drawnArrow.DrawnComponentGuid.ToString() == da.DrawnComponentGuid.ToString())
                    {
